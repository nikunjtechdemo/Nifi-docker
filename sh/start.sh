...
"${NIFI_REGISTRY_BASE_DIR}/scripts/start.sh" run &
...
#trap 'echo NiFi has started. The UI is available at the following URLs:;/opt/nifi/scripts/addingregistry.sh;' TERM HUP INT;

echo NiFi running with PID ${nifi_pid}.
# . "${scripts_dir}/addingregistry.sh"
wait ${nifi_pid}
